...
class ScheduleAnAppointmentDetailPage extends StatefulWidget {
  final Map<String, String> event;

  const ScheduleAnAppointmentDetailPage({super.key, required this.event});

  @override
  State<ScheduleAnAppointmentDetailPage> createState() =>
      _ScheduleAnAppointmentDetailPageState();
}

class _ScheduleAnAppointmentDetailPageState
    extends State<ScheduleAnAppointmentDetailPage> {
